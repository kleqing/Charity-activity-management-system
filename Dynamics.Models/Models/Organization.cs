...
namespace Dynamics.Models.Models
{
    public class Organization
    {
        ...
        [DataType(DataType.EmailAddress)] public string? OrganizationEmail { get; set; }
        [DataType(DataType.PhoneNumber)] public string? OrganizationPhoneNumber { get; set; }
        public string? OrganizationAddress { get; set; }
        public string? OrganizationDescription { get; set; }
        public string? OrganizationPictures { get; set; }
        [DataType(DataType.Date)] public DateOnly StartTime { get; set; }
        [DataType(DataType.Date)] public DateOnly? ShutdownDay { get; set; }
